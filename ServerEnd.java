...
public class ServerEnd {
	...
	private void initialize() throws IOException {
		...
		frmServerChat.getContentPane().setBackground(UIManager.getColor("RadioButtonMenuItem.background"));
		...
		ImageIcon im=new ImageIcon("chat1.jpg");
		frmServerChat.setIconImage(im.getImage());
